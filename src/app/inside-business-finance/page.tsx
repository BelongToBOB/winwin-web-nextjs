...
const faqs = [
  ...
  { question: '"100M Method" คืออะไร', answer: "ระบบ 6 เครื่องมือที่วินใช้ออกแบบโครงสร้างการเงินให้ธุรกิจ SME ขนาด 30–100 ล้าน/ปี — ประกอบด้วย Business Health Reading (อ่านงบเห็นสัญญาณ), Cashflow 4 Layers, Real Profit Framework, Expense Mapping, 5-Bucket System และ 1-Page Business Plan" },
