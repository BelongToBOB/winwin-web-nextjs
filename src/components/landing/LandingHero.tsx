        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 md:gap-16 items-center">
          <div className="order-2 md:order-1 space-y-5">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <CTAButton href={hero.ctaPrimary.url} variant="yellow" target="_blank">
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              ...
              <div className="relative w-52 md:w-64 aspect-[3/4] rounded-card border-2 border-accent/30 overflow-hidden shadow-[0_20px_50px_-12px_rgba(250,204,21,0.15)] bg-gradient-to-b from-surface-2 via-surface to-bg">
                <img
